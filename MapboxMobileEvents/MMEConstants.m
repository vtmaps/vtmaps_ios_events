...
NSString * const MMEAPIClientBaseURL = @"https://dev.viettemaps.vn";
NSString * const MMEAPIClientBaseAPIURL = @"https://dev.viettemaps.vn";
NSString * const MMEAPIClientBaseChinaEventsURL = @"https://dev.viettemaps.vn";
NSString * const MMEAPIClientBaseChinaAPIURL = @"https://dev.viettemaps.vn"; 
